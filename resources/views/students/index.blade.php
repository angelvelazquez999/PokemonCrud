        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="px-4 py-2 text-center">
                    ...
                    class="bg-cyan-500 dark:bg-cyan-700 hover:bg-cyan-600 dark:hover:bg-cyan-800 text-white font-bold py-2 px-4 rounded mr-2">Create</a>     
                </div>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div clas="flex justify-center">
                                        ...
                                        <button type="button"
                                            onclick="confirmDelete('{{ $student->id }}', '{{ $student->name }}', '{{ $student->age }}')"
...
<script>
    function confirmDelete(id, name, age) {
        alertify.confirm(`Are you sure you want to delete ${name}? with age ${age}`, function(e) {
            if (e) {
